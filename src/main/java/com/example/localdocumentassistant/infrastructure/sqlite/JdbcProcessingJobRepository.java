...
public class JdbcProcessingJobRepository implements ProcessingJobRepository {
    ...
    public JdbcProcessingJobRepository(JdbcTemplate jdbcTemplate) {
    ...
    @Override
    public Optional<ProcessingJob> findByJobId(String jobId) {
        List<ProcessingJob> jobs = jdbcTemplate.query(
                """
                        SELECT id,
                               job_id,
                               watched_folder_id,
    ...
    @Override
    public ProcessingJob update(ProcessingJob job) {
        jdbcTemplate.update(
                """
    ...
    private ProcessingJob withId(ProcessingJob job, long id) {
